  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-500">{total} total channels</div>
      </div>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500 text-xs">@{channel.handle}</div>
                    </div>
                  </div>
                </td>
                <td className="px-4 py-3">
                  <div className="text-sm">{channel.owner.name || "No name"}</div>
                  <div className="text-xs text-gray-500">{channel.owner.email}</div>
                </td>
                <td className="px-4 py-3">{channel._count.videos}</td>
                <td className="px-4 py-3">{channel._count.subscriptions.toLocaleString()}</td>
                <td className="px-4 py-3">
                  <span
